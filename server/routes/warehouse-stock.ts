...
const warehouseStock = {
  "VAN462": [
    { code: "CL000101", description: "LMJ SPLICE TRAYS - SOSA", quantity: 25, reserved: 2 },
    { code: "FC-50M", description: "Fiber Optic Cable - 50m", quantity: 15, reserved: 0 },
    { code: "RJ45-100", description: "RJ45 Connectors", quantity: 100, reserved: 10 },
    { code: "CT-200", description: "Cable Ties", quantity: 200, reserved: 5 },
    { code: "JB-08", description: "Junction Box", quantity: 8, reserved: 1 },
  ],
  "VAN123": [
    { code: "CL000101", description: "LMJ SPLICE TRAYS - SOSA", quantity: 15, reserved: 1 },
    { code: "FC-50M", description: "Fiber Optic Cable - 50m", quantity: 8, reserved: 0 },
    { code: "RJ45-100", description: "RJ45 Connectors", quantity: 75, reserved: 5 },
  ],
  "VAN789": [
    { code: "CL000101", description: "LMJ SPLICE TRAYS - SOSA", quantity: 30, reserved: 3 },
    { code: "FC-50M", description: "Fiber Optic Cable - 50m", quantity: 20, reserved: 2 },
  ...
  try {
    ...
    const filteredStock = query 
      ? stock.filter(item => 
          ...
          item.description.toLowerCase().includes(query.toString().toLowerCase())
        )
      : stock;
...
router.get("/warehouse/:warehouseId/stock/:stockCode/availability", (req, res) => {
  try {
...
router.get("/user/:employeeId/warehouses", (req, res) => {
  try {
    ...
    const userWarehouses = {
      "tech001": [
        { id: "VAN462", name: "VAN462", description: "East London Service Van", isDefault: true, warehouseId: "WH-EL-001" }
      ],
      "tech002": [
        { id: "VAN123", name: "VAN123", description: "Port Elizabeth Service Van", isDefault: true, warehouseId: "WH-PE-002" }
      ],
      "tech003": [
        { id: "VAN789", name: "VAN789", description: "Cape Town Service Van", isDefault: true, warehouseId: "WH-CT-003" }
      ],
    };
