      ...
      setProcessingProgress((prev) => {
        if (prev >= 100) {
          ...
          const newOperation: BulkAction = {
            ...
            type:
              currentOperation.type.charAt(0).toUpperCase() +
              currentOperation.type.slice(1),
            name:
        ...
        <TabsContent value="operations" className="space-y-6">
          ...
          {selectedEmployees.length > 0 && (
            <Alert>
              ...
              <AlertDescription>
                {selectedEmployees.length} employee(s) selected for bulk
                operation
              </AlertDescription>
            </Alert>
          )}
                  ...
                  >
                    ...
                    <DialogContent className="max-w-2xl">
                      ...
                      <div className="grid gap-4 py-4">
                          ...
                          <div>
                            ...
                            >
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="department_transfer">
                                  Department Transfer
                                </SelectItem>
                                <SelectItem value="benefit_enrollment">
                                  Benefit Enrollment
                                </SelectItem>
                              </SelectContent>
                            </Select>
                        ...
                        {(currentOperation.type === "bonus" ||
                          currentOperation.type === "deduction" ||
                          currentOperation.type === "salary_adjustment") && (
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                        ...
                        <div className="flex gap-2 pt-4">
                          <Button
                            ...
                            disabled={
                              isProcessing || !currentOperation.description
                            }
                            className="flex-1"
                          >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500 mt-1">
                          ...
                          <span>
                            Targets: {operation.targetCount} employees
                          </span>
                          {operation.status === "running" && (
                            <span>
                              Progress: {operation.processedCount}/
