                        ...
                        {[
                          {
                            ...
                            tools: [
                              ...
                              },
                              {
                                ...
                                status: "Present",
                                imageUploaded: true,
                                imageUrl: "https://images.unsplash.com/photo-1585009508209-ade1f555ea39?w=500",
                                inspectionDate: "2025-01-15",
                              },
                              {
                                id: "TL-2025-029",
                                ...
                                status: "Present",
                                imageUploaded: true,
                                imageUrl: "https://images.unsplash.com/photo-1616328009943-4fa93ff1bc31?w=500",
                                inspectionDate: "2025-01-15",
                              },
                              {
                                id: "FK-2025-036",
                          ...
                          } as Toolbox,
                          {
                            ...
                            tools: [
                              ...
                              },
                              {
                                ...
                                status: "Present",
                                imageUploaded: true,
                                imageUrl: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?w=500",
                                inspectionDate: "2025-01-14",
                              },
                              {
                                id: "FT-2025-064",
                          ...
                          <ToolboxInspection
                            ...
                            toolbox={toolbox}
                            showImageUploadStatus={true}
                            onViewDetails={(toolbox) => console.log('View toolbox details:', toolbox)}
                            onReportIssues={(toolbox) => console.log('Report toolbox issues:', toolbox)}
                            onReassignTools={(toolbox) => console.log('Reassign tools:', toolbox)}
                            onExportReport={(toolbox) => console.log('Export toolbox report:', toolbox)}
                          />
                        ))}
                      </div>
                    </div>
