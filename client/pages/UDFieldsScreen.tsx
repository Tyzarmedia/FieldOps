...
import { X, ChevronUp, ChevronDown, Trash2, RefreshCw } from "lucide-react";
              ...
              <div className="px-4 pb-4 space-y-4 border-t">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleInputChange("maintenanceClassIssue", value)
                    }
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="Select" />
                    ...
                    <SelectContent>
                      <SelectItem value="poor-installation-quality">
                        Poor Installation Quality
                      </SelectItem>
                      <SelectItem value="self-inflicted-poor-installation">
                        Self Inflicted due to poor Installation
                      </SelectItem>
                      <SelectItem value="self-inflicted-gardening-dogs">
                        Self inflicted (gardening, dogs, etc)
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("resolutionComments", e.target.value)
                    }
