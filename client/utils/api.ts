...
export class ApiClient {
  ...
  private async makeRequest<T = any>(
    ...
    try {
      ...
      if (
        ...
        throw new ApiError(
          "Request body was already consumed. Please try again.",
        );
      }
  ...
  async deleteAuthenticated<T = any>(
    url: string,
    token: string,
    config: Omit<RequestConfig, "method" | "body"> = {},
  ): Promise<T> {
...
export const makeSafeRequest = async (
  url: string,
  options: RequestInit = {},
) => {
